                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">   
                                        <p>$${item.price}</p>
                                         <input type="number"  id="qty${item.itemId}">
                                         <button type="button" id="add" value="no" onclick="AddToOrder(${item.itemId}, ${item.price},'foodname${item.itemName}')">Add to order</button>
                                         <div style="display: none" id="foodname${item.itemName}">${item.itemName}</div>
                                        <div>
                                            <input type ="checkbox" Checked id="FavButton${item.itemId}" class="css-checkbox" onclick="AddFavoriteItem(this,${item.itemId})" >
                                            <label for="FavButton${item.itemId}" class="css-label"></label> 
                                        </div>  
