            ...
            <div class="col-lg bg-light">     <!-- form div !-->
                <span style="white-space:nowrap"> <!--forces the labels to not wrap with spaces !-->
                    <form id="editForm" action="edit" method="POST">
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-sm-2 col-form-label">City:</label>
                            <div class="col-sm-4">
                                <input type="text" name="recieverPassword" class="form-control" id="recieverPassword" value="${password}">
                            </div>                            
                        </div>   
